...
import { ARTIST_ON_LINE_KEYS } from '../../../enums/artist';

const blockToBuilderMap = {
	[ARTIST_ON_LINE_KEYS.LINEUP]: lineupClassBuilder.artist,
	[ARTIST_ON_LINE_KEYS.HEADLINERS]: editionClassBuilders.headlines,
};
...
export default function(decorator, blockName = ARTIST_ON_LINE_KEYS.LINEUP) {
	if (!decorator) {
		return null;
	}
